...
export const tools: Tool[] = [
  ...
  { id: 'compress', name: 'Compress PDF', description: 'Reduce PDF file size using object streams', category: 'optimize', icon: 'Minimize2', inputType: 'single', inputLabel: 'Single PDF', outputLabel: 'Smaller PDF', pipelineCompatible: true },
